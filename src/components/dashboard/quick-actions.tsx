import { NotebookPen, LayoutGrid, UserRound, ChevronRight, type LucideIcon } from "lucide-react"
...
const actions: Action[] = [
  { label: "Write New Post", icon: NotebookPen },
  { label: "View All Blogs", icon: LayoutGrid },
  { label: "Go to Profile", icon: UserRound },
]

export function QuickActions() {
  return (
    <div className="rounded-2xl border border-outline-variant/10 bg-surface-container-low p-8">
      <h4 className="mb-6 font-display text-lg font-bold text-foreground">Quick Actions</h4>
